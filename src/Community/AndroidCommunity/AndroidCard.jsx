  ...
  return (
    <div className="card w-96 bg-base-100 shadow-xl">
      ...
      <div className="card-body">
        <div>
          <h2 className="card-title">{courseName}
            <div className="badge badge-secondary">${price}</div></h2>
        ...
        <div className='flex justify-between items-center'>
          ...
          <Link  to={`/androidDetails/${_id}`}><button className='bg-[#00ab15] rounded-full px-6 py-2 font-semibold hover:bg-gray-500 text-white'> Enroll Now</button></Link>
        </div>
      </div>
    </div>
  )
