    ...
    return (
        <div className='bg-[#ECF1F5] font-serif'>
            ...
            <div className='flex justify-center'>
                <h1 className='mt-20 mb-14 loading-[100%] text-black text-[3rem] font-bold'> Our Responsibility</h1>
            </div>


            <div className='grid grid-cols-1 gap-3 container md:grid-cols-2  lg:grid-cols-4 justify-items-center mx-auto'>
