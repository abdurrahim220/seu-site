...
const Responsibility = () => {
    return (
        <div className='bg-[#ECF1F5]'>
            ...
            <div className='mt-10'>
                <div className='my-10'>
                    <h1 className=' text-black text-5xl text-center font-bold'> Our Responsibility</h1>
                </div>
                <div className='grid group: grid-cols-1 gap-3 md:grid-cols-2 max-w-screen-xl lg:grid-cols-4 justify-items-center mx-auto'>
